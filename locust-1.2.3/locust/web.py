...
class WebUI:
    ...
    greenlet = None
    """
    Greenlet of the running web server正在运行的web服务器的Greenlet 
    """
    ...
    def __init__(
        ...
        创建web实例并在单独的greenlet中运行web服务器(self.greenlet)

        Arguments:
        environment: Reference to the current Locust Environment 参考当前蝗虫环境
        ...
        def index():
            ...
            if environment.host:
                ...
                if len(all_hosts) == 1:
                    ...
                    # 因为我们有多个具有不同主机属性的User类，所以我们将通知指定host将覆盖所有User类的主机
