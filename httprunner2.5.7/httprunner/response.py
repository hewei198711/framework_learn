...
class ResponseObject(object):
    ...
    def _extract_field_with_delimiter(self, field):
        ...
        # elapsed 经过、时间
        # available attributes: days, seconds, microseconds, total_seconds可用属性:天，秒，微秒，总秒
        ...
        # response body
            ...
            # isdigit() 方法检测字符串是否只由数字组成
                ...
                # content = "abcdefg", content.3 => d  body字符串只包含数字
                return utils.query_json(body, sub_query)
            else:
                # content = "<html>abcdefg</html>", content.xxx  Body是html,那就是错误的
    ...
    def extract_response(self, extractors):
        """ extract value from requests.Response and store in OrderedDict.
            从requests.Response中提取值，存储在有序的字典中
        ...
        Returns:
            OrderDict: variable binds ordered dict变量绑定有序的字典
